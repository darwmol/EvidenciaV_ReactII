...
const ListaPersonajes = () => {
  ...
  return (
    <div>
      <img src="rick-and-morty-logo.png" alt="Descripción de la imagen"/>
        ...
        <ul>
          {data.results.map((personaje) => (
            <div className = "card" key={personaje.id}>
              <img className= "image" src={personaje.image} />
              <div>
              <Link className= "button" to={`/personaje/${personaje.id}`}>{personaje.name}</Link>
              </div>
